...
namespace Drupal\auto_term_translate\Plugin\Derivative;
 ...
 */
class AutoTermTranslateLocalTasks extends DeriverBase implements ContainerDeriverInterface {
  ...
  /**
   * Constructs a new AutoTermTranslateLocalTasks.
   *
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    // Create tabs for all taxonomy_terms types.
    foreach ($this->contentTranslationManager->getSupportedEntityTypes() as $entity_type_id => $entity_type) {
      if ($entity_type_id == 'taxonomy_term') {
        ...
        $this->derivatives['entity.taxonomy_term.auto_term_translate'] = [
