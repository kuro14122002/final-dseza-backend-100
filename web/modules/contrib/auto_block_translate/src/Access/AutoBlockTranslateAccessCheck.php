...
namespace Drupal\auto_block_translate\Access;
 ...
 */
class AutoBlockTranslateAccessCheck implements AccessInterface {
  ...
  /**
   * Constructs a AutoBlockTranslateAccessCheck object.
   *
   ...
   *   The access result.
   */
  public function access(RouteMatchInterface $route_match, AccountInterface $account, $entity_type_id = 'block_content') {
